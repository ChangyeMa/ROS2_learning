...
class LedStates(metaclass=Metaclass_LedStates):
    ...
    def __init__(self, **kwargs):
        ...
        self.states = array.array('q', kwargs.get('states', []))
    ...
    def states(self, value):
        if isinstance(value, array.array):
            assert value.typecode == 'q', \
                "The 'states' array.array() must have the type code of 'q'"
            self._states = value
            return
        if __debug__:
            ...
            assert \
                ...
                "The 'states' field must be a set or sequence and each value of type 'int' and each integer in [-9223372036854775808, 9223372036854775807]"
        self._states = array.array('q', value)
